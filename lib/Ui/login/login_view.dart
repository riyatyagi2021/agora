...
import 'package:agora/Ui/login/login_repository.dart';
...
class _LoginState extends State<Login> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      child: Scaffold(body: BlocConsumer<LoginBloc, LoginState>(
                      ...
                      Container(
                        ...
                        child: RaisedButton(
                          ...
                          onPressed: (state.isValidationSuccess &&
                              ...
                              ? ()=>loginbloc.add(OnLoginApiHit(email.text,password.text))
                              : null,
                        ),
                      ),
                      RichText(
