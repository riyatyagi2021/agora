...
class Home extends StatefulWidget {
  ...
  Home({Key? key, this.loginModel}) : super(key: key);
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(NAME.toString()),
                                //widget.loginModel!.res!.user!.name.toString()
                                Text(EMAIl.toString()),
                                //widget.loginModel!.res!.user!.email.toString()
                              ],
                            )
                          ],
                        ),
                  ...
                  child: Column(
                    children: [
                      ...
                      ListView.builder(
                        ...
                        scrollDirection: Axis.vertical,
                        itemCount: 2,
                        // productListModel?.res?.products productListModel?.res?.products?.length         ,// productListModel!.res!.products!.length !=null?productListModel!.res!.products!.length:1,
                        itemBuilder: (BuildContext context, int index) {
                          var listProducts = state.model.res?.products![index];
                          //  print(state.prefUtils.+"kjhgfdsfg");
                          var name =
                              state.loginModel.res?.user?.name.toString();
                          ...
                          PreferenceUtils.getLoginBp().then((bP) {
                            ...
                            print("${bp} hjjhjjhj");
                            print(
                                "${bp.toString()}${PROFILE.toString()} image picture getting?");
                          });
                          return Container(
                            height: 600,
                            width: MediaQuery.of(context).size.width,
                                              ...
                                              child: ClipRRect(
                                                child: FadeInImage.assetNetwork(
                                                  placeholder:
                                                      'assets/images/u1.jpeg',
                                                  image:
                                                      '${state.model.res?.bP?.toString()}${listProducts?.userImg.toString()}',
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      listProducts?.price
                                                              ?.toString() ??
                                                          '\$300',
                                                      //productListModel?.res?.products![index].price.toString() !=null ?  productListModel!.res!.products![index].price.toString():'\$100.03',
                                                      style: TextStyle(
                                                          fontWeight:
                                                              FontWeight.bold,
                                                          fontSize: 16),
